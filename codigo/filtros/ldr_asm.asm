...
aplicarFiltroldr:
	...
	.ciclo:
		...
		call sumarPixeles
		paddd xmm14, xmm0					; me guardo el resultado en xmm14 (ojo! porq esta en dw)
...
sumarPixeles:
	...
	pxor xmm7, xmm7
	punpcklwd xmm0, xmm7				; xmm0 =
	punpcklwd xmm1, xmm7				; xmm0 =

	paddd xmm0, xmm1					; xmm0 = R0+G0+B0 + R1+G1+B1 | . | . | . | R1+G1+B1 | . | . | .
ret
